...
const alien_color = 'green'; // You can change this value to 'yellow' or 'red' to test different scenarios
...
const usernames = ["Hamad", "Elonmusk", "Usman", "Charlie", "David"];
...
let current_users = ["Hamad", "Einstein", "Usman",
    "Huzaifa", "Abdullah"];
let new_users = ["Asif", "Kamran", "Zain",
...
const Fav_Pizzas = ["BQ checken", "MalaiBoti", "pepperoni"];
...
let size = "medium";
let messege = "Typescript Insights with Kamran";
...
function makeShirt(Size = "Large", messege = "I love bockchain expert") {
...
const magicianName = [" Herry pooter", "Ip man", "Carry on jatta", "Maula jutt"];
...
const magicianName3 = [" Herry pooter", "Ip man", "Carry on jatta", "Maula jutt"];
...
const greatMagiciansName = make_great(magicianName);
...
const magicianName2 = [" Herry pooter", "Ip man", "Carry on jatta", "Maula jutt"];
function showmagicians2(magician) {
    for (const item of magician) {
        console.log(item);
    }
}
function makegreat(magician) {
    const greatMagicians2 = magician.map(magician => `The Great ${magician}`);
    return greatMagicians2;
}
const greatMagiciansName2 = make_great(magicianName2);
