...
let uppercase:string = User.toUpperCase();
console.log(uppercase);

// in titlecase

let word:string[] = User.split(" ");
...
var quote: string = "He Said,People who have no hold over their process of thinking are likely to be ruined by liberty of thought.";
var author: string = "Allama Iqbal";
...
let message2: string = `${person} once said, 'Imagination is more important than knowledge.'`;
...
// Adding
let Adding:number =  6+8;
console.log("Addition",Adding);    

// Multiplying
let Multiplying:number = 6*8;
console.log("Multiplication",Multiplying);
 
// Substraction
let Substraction:number = 6-8;
console.log("Substraction",Substraction);
 
// dividing
let dividing:number = 6/8;
...
const names: string[] = ["Hamad", "Huzaifa", "Abdullah", "Mateen"];
...
const Names: string[] = ["Hamad", "Usman", "Ali", "Subhan"];
...
const motorcycles: string[] = ["Honda", "Yamaha", "Kawasaki", "Harley-Davidson"];
...
const guestList4: string[] = ["Huzaifa", "Hamad", "Abdullah"];
...
const guestList:string[] = ["Abu bakar", "Muhmmad saleem", "Zain"];

const guestCannotAttend: string = "Naeem";
const replacementGuest: string = "John Smith";

const updatedGuestList: string[] = guestList.map(guest => (guest === guestCannotAttend) ? replacementGuest : guest);
...
let guests: string[] = ["Abdullah", "huzaifa", "Hamad"];
...
// //!(1) Start with your program from Exercise 16. Add a new line that prints a message saying that you can invite only two people for dinner.
  let Guestlist:Array<String> = ["Hamad","Huzaifa","Usman","Ali","Waleed","Zafar","Anees"];
...
let Destination:String[] = ["Pakistan","India","America","Turkey"];
...
const countries:string[] = ["USA","Pakistan",
...
console.log(`Fruits at index ${invalid}:`,fruits
[invalid]);
...
// Test for inequality
let isNotEqual: boolean = string1 !== string2; // True
let name1: string = "Alice";
let name2: string = "Bob";

// Test for equality
let areNamesEqual: boolean = name1 === name2; // False

// Test for inequality
let areNamesNotEqual: boolean = name1 !== name2; // True

// Tests using the lower-case function
let text: string = "Hello World";

// Test if lowercase equals "hello world"
let isLowercaseEqual: boolean = text.toLowerCase() === "hello world"; // True

// Test if lowercase not equals "hello world"
let isLowercaseNotEqual: boolean = text.toLowerCase() !== "hello world"; // False
...
//  Test for equality
let isNumEqual: boolean = num1 === num2; // False

// Test for inequality
let isNumNotEqual: boolean = num1 !== num2; // True

// Test if num1 is greater than num2
let isNumGreaterThan: boolean = num1 > num2; // True

// Test if num1 is less than num2
let isNumLessThan: boolean = num1 < num2; // False

// Test if num1 is greater than or equal to num2
let isNumGreaterThanOrEqual: boolean = num1 >= num2; // True

// Test if num1 is less than or equal to num2
let isNumLessThanOrEqual: boolean = num1 <= num2; // False
